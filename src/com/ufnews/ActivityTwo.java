...
public class ActivityTwo extends Activity {
        ...
        webView.setWebViewClient(new WebViewClient(){
        	...
        	public boolean shouldOverrideUrlLoading(WebView view, String url) {
    			...
    			if (android.os.Build.VERSION.SDK_INT >= 19) {
    				if (url != null && url.contains("wind=new2") ) {
    ...
    public class MyJSInterface{
    	...
    	@JavascriptInterface
    	void showLeftImage_two(){
    		webView.loadUrl("javascript:showLeftImage()");
    	}
    	void showRightImage_two(){
    		webView.loadUrl("javascript:showRightImage()");
    	}
    	@JavascriptInterface
    	public void vibration_two(){
	      Vibrator vib = (Vibrator)ActivityTwo.this.getSystemService(Context.VIBRATOR_SERVICE);
	      vib.vibrate(500);
    	...
    	@JavascriptInterface
     	public void parent_reload(){
    		refre();
     	}
    	
    	@JavascriptInterface
     	public void app_exit_two(){
     		finish();
     	}
    	...
    	public void share_data(String murl,String mtext){
     	...
     	@JavascriptInterface
     	public void app_update_two(){
     		Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.ufnews"));
     		startActivity(intent);
     	}
     	@JavascriptInterface
     	public boolean win_cls_two(){
     		webView.goBack();
            return true;
     	}
     	
     	@JavascriptInterface
     	public void alert_toast_two(String alertstr ){     		
	...
	public void refre(){
    	((MainActivity)(MainActivity.mContext)).main_reload();
    }
